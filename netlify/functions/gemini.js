            ...
            case "matematik_geometri":
                ...
                **LGS Matematik/Geometri Çözüm Stratejisi:**
                ...
                4.  **ÖZEL STRATEJİ: "Olamaz" Tipi Sorular ve Çoklu Olasılıklar (Çok Kritik!):** Eğer soru "hangisi olamaz?" veya "hangileri olabilir?" tipi bir soruysa:
                    *   **Tüm olası durumları veya sonuçları eksiksiz belirle.** Örneğin, bir şeklin birden fazla şekilde tamamlanması gerekiyorsa (örn. 8 birim kareden oluşan dikdörtgen 8x1 veya 4x2 olabilir), **tüm bu durumları ayrı ayrı listele.**
                    *   **Her olası durum için istenen değeri (örn. köşegen eğimi) hatasız hesapla.**
