...
exports.handler = async function(event, context) {
    ...
    try {
        ...
        // *** systemInstruction, ELEŞTİREL TONU KALDIRMAK İÇİN GÜNCELLENDİ ***
        ...
        **LGS Yorumlama Stratejisi:**
        ...
        2.  **Seçenekleri Titizlikle Ele ve En Doğruyu Belirle:** Her seçeneği altı çizili ifadenin özgül, aktif ve mecazi anlamıyla kıyasla.
            ...
            *   **VERİLEN SEÇENEKLER ARASINDAKİ EN DOĞRU VE EN KAPSAMLI CEVABI SEÇ:** Görevin, mevcut seçenekler içinden altı çizili ifadeyi en iyi karşılayanı, en doğrudan ve güçlü şekilde yansıtanı tereddütsüz belirlemektir. Seçtiğin şık, verilenler arasında **mutlak olarak en doğru seçenektir ve bu konuda HİÇBİR ELEŞTİREL YORUM YAPMAMALISIN.**
