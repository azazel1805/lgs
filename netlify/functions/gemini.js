        ...
        switch (questionType) {
            ...
            case "matematik_geometri":
                ...
                **LGS Matematik/Geometri Çözüm Stratejisi:**
                1.  **Soruyu ve Verileri Hataız Tespit Et:** Verilen metni ve/veya görseli dikkatlice oku. Tüm sayısal verileri, şekillerin özelliklerini (kare, dikdörtgen, üçgen, birim kare vb.) ve isteneni (alan, çevre, oran, eşitsizlik, eğim vb.) doğru tespit et. **Görselde kareli zemin varsa, birim karelerin kenarlarını sayarak şekillerin boyutlarını doğru tespit et.**
                2.  **Adım Adım, Mantıksal ve Formüllere Uygun Çözüm:** Problemi çözmek için gerekli tüm matematiksel/geometrik adımları, formülleri (örn. alan, çevre, Pisagor, eğim formülü Eğim = $\frac{\Delta y}{\Delta x}$) ve mantıksal çıkarımları eksiksiz ve hatasız uygula. Her adımı açıkla.
                ...
                4.  **ÖZEL STRATEJİ: "Olamaz" Tipi Sorular ve Çoklu Olasılıklar:** Eğer soru "hangisi olamaz?" veya "hangileri olabilir?" tipi bir soruysa:
                    *   Tüm olası durumları veya sonuçları (örn. bir şeklin birden fazla şekilde tamamlanması, köşegen eğimlerinin pozitif/negatif değerleri) eksiksiz belirle.
                    *   Hesapladığın tüm olası sonuçları bir liste halinde oluştur.
                    *   **Seçenekleri bu liste ile kıyasla.** Olası sonuçlar listende olmayan seçeneği doğru cevap olarak işaretle. Eğer birden fazla "olamaz" seçenek varsa ve soru tek bir cevap bekliyorsa, bunu nötr bir dille belirt ancak kendi analizinde tüm "olamaz" seçenekleri göster.
                ...
                7.  **Doğru Cevabı Gerekçelendir:** Eğer tam eşleşen veya "olamaz" tipi sorularda istenen koşulu sağlayan bir seçenek bulunursa, o seçeneğin neden diğerlerinden daha üstün ve kesinlikle doğru olduğunu, tüm adımları, formülleri ve mantıksal çıkarımları karşılaştırarak adım adım, açık ve anlaşılır şekilde gerekçelendir.
                8.  **Yapılandırılmış Yanıt:** Cevabını "1. Sorunun ve Verilenlerin Analizi", "2. Adım Adım Çözüm ve Mantıksal Çıkarımlar", "3. Olası Sonuçların Değerlendirilmesi ve Seçenek Elemesi", "4. Doğru Cevap" başlıkları ve madde işaretleri kullanarak yapılandır.`;
                break;
            case "fen_bilimleri":
                specificInstruction = `
