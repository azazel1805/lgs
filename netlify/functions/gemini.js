        ...
        switch (questionType) {
            ...
            case "dilbilgisi":
                ...
                **LGS Dil Bilgisi (Fiil Çatısı/Cümle Türleri vb.) Stratejisi:**
                ...
                5.  **Yapılandırılmış Yanıt:** Cevabını "1. Metin/Fiiller/Cümlelerin Analizi ve Dil Bilgisi Kuralı Uygulaması", "2. Seçeneklerin Değerlendirmesi ve Elemesi", "3. Doğru Cevabın Kapsamlı Gerekçesi" başlıkları ve madde işaretleri kullanarak yapılandır.`;
                break;
            case "matematik_geometri":
                ...
                **LGS Matematik/Geometri Çözüm Stratejisi:**
                ...
                3.  **ÖZEL STRATEJİ: Eşitsizlik ve Aralık Soruları:** Eğer soru bir değerin alabileceği aralığı soruyorsa (örn. en az, en fazla, arasında), o değerin **minimum (alt sınır)** ve **maksimum (üst sınır)** değerlerini verilen koşullara göre ayrı ayrı hesapla. Örneğin, C noktası A'dan (65m) en az 35m yukarıdaysa, alt sınırı $65 + 35 = 100$'dur ($x \ge 100$). C noktası B'den (160m) en az 35m aşağıdaysa, üst sınırı $160 - 35 = 125$'tir ($x \le 125$). Bu iki eşitsizliği birleştirerek (100 \le x \le 125) doğru aralığı bul. Bu tür mantıksal çıkarımları hatasız yap.
                4.  **Matematiksel Eşdeğerlikleri Doğru Algıla:** Seçeneklerdeki üslü sayılar, köklü ifadeler veya eşitsizlikler gibi matematiksel ifadelerin sayısal karşılıklarını hatasız hesapla ve senin bulduğun sonuçla eşleştir. Seçenekleri bu eşdeğerlikleri göz önünde bulundurarak değerlendir.
                5.  **Seçenekleri Titizlikle Ele ve En Doğruyu Belirle:** Yaptığın tüm analizler ve hesaplamalarla her seçeneği birebir kıyasla. **Bulduğun kesin sayısal sonuç, seçeneklerdeki herhangi bir değerle TAM OLARAK EŞLEŞMİYORSA, o zaman KESİNLİKLE HİÇBİR SEÇENEĞİ İŞARETLEME.** Bu durumda, kendi bulduğun kesin sonucu ve şıklarda neden tam bir eşleşme olmadığını (sorunun hatalı olduğunu belirtmeden, nötr bir dille), öğrencilere yönelik eğitici bir not olarak ifade et. Yanlış seçenekleri neden hatalı olduğunu açıklayarak ele.
                6.  **Doğru Cevabı Gerekçelendir:** Eğer tam eşleşen bir seçenek bulunursa, o seçeneğin neden diğerlerinden daha üstün ve kesinlikle doğru olduğunu, tüm adımları, formülleri ve mantıksal çıkarımları karşılaştırarak adım adım, açık ve anlaşılır şekilde gerekçelendir.
                7.  **Yapılandırılmış Yanıt:** Cevabını "1. Sorunun ve Verilenlerin Analizi", "2. Adım Adım Çözüm ve Mantıksal Çıkarımlar", "3. Seçeneklerin Değerlendirilmesi ve Doğru Cevap" başlıkları ve madde işaretleri kullanarak yapılandır.`;
                break;
            case "fen_bilimleri":
                specificInstruction = `
